...
CREATE TABLE approval_requests (
    ...
    , content TEXT DEFAULT '', title TEXT DEFAULT '', result_note TEXT DEFAULT '', persist TEXT DEFAULT 'persistent', target_id TEXT DEFAULT '', consumed INTEGER DEFAULT 0, payload TEXT DEFAULT '', is_demo INTEGER DEFAULT 0);
...
CREATE TABLE crm_projects (
    ...
    , status TEXT DEFAULT 'active', owner_user_id TEXT DEFAULT '', is_demo INTEGER DEFAULT 0);
...
CREATE TABLE lost_projects (
        ...
        q6_rmb INTEGER DEFAULT 0, q6_usd INTEGER DEFAULT 0, q6_vnd INTEGER DEFAULT 0,
        q7_rmb INTEGER DEFAULT 0, q7_usd INTEGER DEFAULT 0, q7_vnd INTEGER DEFAULT 0
    , owner_user_id TEXT DEFAULT '', is_demo INTEGER DEFAULT 0);
...
CREATE TABLE users (
            ...
            created_at TEXT DEFAULT ''
        , position TEXT DEFAULT '', vis_can_see_me TEXT DEFAULT '[]', vis_he_can_see TEXT DEFAULT '[]', perms TEXT DEFAULT '{}', delegate_to TEXT DEFAULT '', forgot_approvers TEXT DEFAULT '[]');
...
CREATE TABLE won_projects (
    ...
    doc_remark       TEXT
, attachments TEXT DEFAULT '[]', supp_summary TEXT DEFAULT '[]', created_at TEXT DEFAULT '', updated_at TEXT DEFAULT '', warranty_rmb INTEGER DEFAULT 0, warranty_usd INTEGER DEFAULT 0, warranty_vnd INTEGER DEFAULT 0, warranty_start TEXT DEFAULT '', warranty_end TEXT DEFAULT '', owner_user_id TEXT DEFAULT '', is_demo INTEGER DEFAULT 0);
